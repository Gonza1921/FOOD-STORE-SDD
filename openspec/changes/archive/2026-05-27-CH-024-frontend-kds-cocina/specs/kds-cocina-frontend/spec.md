# Spec: KDS Frontend — Kitchen Display System

## Overview

Interfaz de cocina en tiempo real para que el personal con roles `COCINA`, `PEDIDOS` y `ADMIN` visualice y gestione pedidos activos. Utiliza WebSocket para actualizaciones en vivo con fallback polling, layout Kanban de 2 columnas, indicadores de urgencia visual y controles de avance de estado (Iniciar / Listo).
