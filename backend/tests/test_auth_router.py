...
def register_test_user(email: str = "test@example.com") -> dict:
...
class TestAuthEndpoints:
    ...
    def test_refresh_returns_200(self):
        ...
        auth_data = register_test_user("refresh-test@example.com")
    ...
    def test_logout_returns_204(self):
        ...
        # Register and get tokens
        auth_data = register_test_user("logout-test@example.com")
    ...
    def test_protected_route_with_insufficient_role_returns_403(self):
        ...
        auth_data = register_test_user("rbac-test@example.com")
        access_token = auth_data["accessToken"]
